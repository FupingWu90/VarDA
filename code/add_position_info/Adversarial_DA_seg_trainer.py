...
prefix='~/experiments/loss_four_tSNE'
...
def ADA_Train(source_vae_loss_list,source_seg_loss_list,target_vae_loss_list,distance_loss_list, Train_LoaderA,Train_LoaderB,Infonet,encoder,decoderA,decoderAdown2,decoderAdown4,decoderB,decoderBdown2,decoderBdown4,gate,DistanceNet,lr,kldlamda,predlamda,alpha,beta,infolamda,epoch,optim, savedir):
    lr=lr*(0.9**(epoch))
...
def SegNet_test_mr(test_dir, mrSegNet, gate,epoch,ePOCH, save_DIR):
    criterion=0
    for dir in test_dir:
